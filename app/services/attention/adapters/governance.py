    ...
    for handoff in handoffs or []:
        ...
        items.append(
            create_attention_item_v2(
                ...
                title=_value(getattr(handoff, "title", "")) or "Intervencion humana pendiente",
                reason=_value(getattr(handoff, "summary", "")) or "Existe un handoff pendiente de decision humana.",
                impact="Puede bloquear la promocion o exportacion del entregable.",
                consequence_if_unresolved="El flujo seguira esperando la decision del responsable asignado.",
                action_kind="confirm",
