...
from app.services.stage5_service import (
    ...
    FEATURE_FLAG_OBJECTIVE_CONTRACT,
    FEATURE_FLAG_OBJECTIVE_GATE,
    FEATURE_FLAG_OBJECTIVE_LOOP,
    FEATURE_FLAG_OBJECTIVE_QUESTIONS,
    FEATURE_FLAG_OPERATIONAL_ARCHITECTURE_DETECTION,
...
DEFAULT_FEATURE_FLAGS = [
    ...
    },
    {
        ...
        "enabled": False,
        "description": "Autoriza lotes transaccionales y auditados de migracion del backlog Premium heredado.",
        "stage_hint": "migration",
    },
    {
        "key": FEATURE_FLAG_OPERATIONAL_ARCHITECTURE_DETECTION,
        "enabled": True,
        "description": "Permite detectar casos de agente operador de aplicaciones y proyectarlos como diseno/ACP, sin ejecutar acciones reales.",
        "stage_hint": "architecture",
    },
    {
        "key": FEATURE_FLAG_OBJECTIVE_CONTRACT,
        "enabled": True,
        "description": "Genera Objective Contract portable para Blueprint/ACP sin activar gates ni Objective Loop runtime por si solo.",
        "stage_hint": "acp",
    },
    {
        "key": FEATURE_FLAG_OBJECTIVE_QUESTIONS,
        "enabled": False,
        "description": "Muestra preguntas ACP para validar o corregir objetivos inferidos reutilizando Responder preguntas.",
        "stage_hint": "acp",
    },
    {
        "key": FEATURE_FLAG_OBJECTIVE_GATE,
        "enabled": False,
        "description": "Convierte la validacion de objetivos en gate bloqueante solo en pilotos controlados.",
        "stage_hint": "acp",
    },
    {
        "key": FEATURE_FLAG_OBJECTIVE_LOOP,
        "enabled": False,
        "description": "Permite exportar runtime Objective Loop cuando el diseno lo requiere y el workspace lo active explicitamente.",
        "stage_hint": "runtime",
    },
    {
