...
class Settings(BaseSettings):
    ...
    payu_environment: str = "sandbox"
    payu_api_base_url: str = ""
    payu_checkout_base_url: str = ""
    payu_webhook_public_url: str = ""
    payu_api_key: str = ""
    payu_api_login: str = ""
    payu_merchant_id: str = ""
    payu_account_id: str = ""
    payu_webhook_signing_secret: str = ""
    ...
    rapyd_webhook_public_url: str = ""
    rapyd_access_key: str = ""
    rapyd_secret_key: str = ""
    rapyd_webhook_url_secret: str = ""
    rapyd_request_timeout_seconds: int = 30
    rapyd_max_retries: int = 3
